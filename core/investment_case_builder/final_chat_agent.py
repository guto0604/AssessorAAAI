...
from core.investment_case_builder.prompts import build_final_chat_prompts
...
class FinalConsultativeChatAgent(BaseInvestmentCaseAgent):
    ...
    def answer(self, *, question: str, case_state: dict) -> str:
        system_prompt, user_prompt = build_final_chat_prompts(question=question, case_state=case_state)
